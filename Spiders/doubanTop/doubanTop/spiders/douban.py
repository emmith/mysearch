...
class DoubanSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.douban.com/doulist/46373995/']

    # 主站链接 用来拼接
    url = 'https://www.douban.com/doulist/'
    all_urls = ['46373996', '46283721', '46373997', '46428305', '111404105', '122258820', '134440270']
    index = 0
    ...
    def parse(self, response):
        ...
        if nextLink:  # 判断是否到了最后一页
            ...
            if index < len(self.all_urls):
                nextLink = self.url + self.all_urls[index]
                index += 1
                print("爬取下一个网站：" + nextLink)
                yield Request(nextLink, callback=self.parse)  # 爬取下一个网站
