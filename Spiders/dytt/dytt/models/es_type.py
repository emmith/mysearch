# -*- codeing: utf-8 -*-
from elasticsearch_dsl import Document, Keyword, Text, Double, Integer, Date, Completion
from elasticsearch_dsl.connections import connections

es = connections.create_connection(hosts=['localhost'])


class DyttType(Document):
    class Index:
        name = "video_dytt10"
        doc_type = "_doc"
        # settings = {
    ...
    def __init__(self, item):
        super(DyttType, self).__init__()  # 调一下父类的init，避免init重写导致一些init操作没执行
